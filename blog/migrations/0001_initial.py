    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aria_label', models.CharField(blank=True, help_text='Accessible label for screen readers', max_length=200)),
                ('alt_text', models.CharField(blank=True, help_text='Alternative text for featured image', max_length=200)),
